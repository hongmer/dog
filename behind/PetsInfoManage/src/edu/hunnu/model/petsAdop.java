...
public class petsAdop implements Serializable{
	...
	public String getPets_lmWechat() {
		return pets_lmWechat;
	}

	public void setPets_lmWechat(String pets_lmWechat) {
		this.pets_lmWechat = pets_lmWechat;
	}
